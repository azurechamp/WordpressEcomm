 ...
 * @return void
 */
function thb_breadcrumb_trail( $args = array() ) {

	$breadcrumb = apply_filters( 'breadcrumb_trail_object', null, $args );

	if ( !is_object( $breadcrumb ) )
		$breadcrumb = new thb_Breadcrumb_Trail( $args );
...
class thb_Breadcrumb_Trail {
	...
	protected function add_singular_items() {
		...
		if ( $post_title = thb_ShortenText(single_post_title( '', false ),30) ) {
