...
function thb_ocdi_import_files() {
    return array(
        array(
            'import_file_name'       => 'Uberstore',
            'import_file_url'        => "http://themes.fuelthemes.net/theme-demo-files/uberstore/demo-content.xml",
            'import_widget_file_url' => "http://themes.fuelthemes.net/theme-demo-files/uberstore/widget_data.json",
            'import_theme_options_url' => "http://themes.fuelthemes.net/theme-demo-files/uberstore/theme-options.txt"
        )
    );
}
