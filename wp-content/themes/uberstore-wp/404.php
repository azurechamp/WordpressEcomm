...
<section class="small-12 medium-6 columns notfound">
	<div class="content404">
	  <h4><?php _e( "We are sorry, <br> but the page you're <br> looking for cannot<br> be found.", 'uberstore' ); ?></h4>
	  
	  <p><?php _e( 'You might try searching our site or visit the <strong><a href="'.$home.'">homepage</a></strong>.', 'uberstore' ); ?></p>
	  <?php get_search_form(); ?> 
	  <div class="title"><?php _e( "Follow UberStore", 'uberstore' ); ?></div>
